        ...
        modules = [
          ...
          (
            { config, lib, ... }:
            {
              ...
              services.reiMaidsProduction.vueFrontend.enable = false;
              ...
              # Both sites sync static files before nginx serves them.
              systemd.services.nginx = lib.mkIf (
                config.services.zacksMaidsProduction.enable && config.services.reiMaidsProduction.enable
              ) {
